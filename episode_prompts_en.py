...
EPISODES: dict[int, dict[str, str]] = {
    ...
    25: {
        ...
        "d": f"Free crane doing graceful dance gathering rice grains into neat pile with wing breeze, miller offering fresh flour sack from floating mill, sunset over lagoon, {STYLE}",
    },
    26: {
        "setting": "alpine pasture FrancaVilla with wooden barn, morning mist, stream shade and cowbells",
        "footwear": "giant yellow dew boots",
        "a": f"{BASE} in giant yellow dew boots carrying clean milk pail, walking misty pasture path toward dairy at dawn, cowbells, gentle THUMP, breakfast porridge errand, {STYLE}",
        "b": f"Spotted black-white calf Renatiella sitting sadly in fence corner refusing hay, tears, only eating from one shaded stream-side patch she calls blue grass, {BASE} approaching in yellow boots, {STYLE}, alpine meadow FrancaVilla",
        "c": f"{BASE} spraying blueberry juice on grass with trunk, purple stains on yellow boots ears and milk pail, confused calf turning away, comic coloring chaos, FOCUS, {STYLE}",
        "d": f"Vet and milkmaid tying blue ribbon stake at stream meadow corner, calf eating tender regrowth happily, warm milk pail and honey porridge thermos gift for {BASE}, gentle sunrise, {STYLE}",
    },
    27: {
